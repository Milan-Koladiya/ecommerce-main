      ...
      >
        ...
        <div className="d-flex align-items-center gap-3">
          ...
          <p className="mb-0 text-primary" role="button" style={{ cursor: 'pointer' }} onClick={handleCart}>
            <img width="40" height="40" src="/image/cart.png" alt="Cart" className="rounded-circle border" />
          </p>

          <p className="mb-0 text-primary" role="button" style={{ cursor: 'pointer' }} onClick={handleOrder}>
            <img width="40" height="40" src="/image/order.png" alt="Order" className="rounded-circle border" />
          </p>
          ...
          {!authUser?<button className="btn btn-danger" onClick={handleRegister}>
            Join us
          </button>:null}
